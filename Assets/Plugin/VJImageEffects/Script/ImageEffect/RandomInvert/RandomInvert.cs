...
{
    [System.Serializable, VolumeComponentMenu("Post-processing/VJKit/RandomInvert")]
    public sealed class RandomInvert : CustomPostProcessVolumeComponent, IPostProcessComponent
    {
        ...
        {
            _material = CoreUtils.CreateEngineMaterial("Hidden/VJKit/PostProcess/RandomInvert");
        }
